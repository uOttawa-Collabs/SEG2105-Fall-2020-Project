...
public class AccountTest
{
    ...
    {
        EmployeeAccount aEmployeeUser = new EmployeeAccount("benEmployee", "123456", "Employee",
                                                            "Ben", "Alex", "benalex@gmail.com");
    ...
    public void checkEmployeeUserName()
    {
        EmployeeAccount aEmployeeUser = new EmployeeAccount("benEmployee", "123456", "Employee",
                                                            "Ben", "Alex", "benalex@gmail.com");
        assertEquals("Check the username of the employee", "benEmployee",
                     aEmployeeUser.getUsername());
    }
    ...
    public void checkEmployeeEmail()
    {
        EmployeeAccount aEmployeeUser = new EmployeeAccount("benEmployee", "123456", "Employee",
                                                            "Ben", "Alex", "benalex@gmail.com");
        assertEquals("Check the email of the employee", "benalex@gmail.com",
                     aEmployeeUser.getEmail());
    }

    @Test
    public void checkCustomerRole()
    {
        CustomerAccount aCustomerUser = new CustomerAccount("Jimmy", "112233", "Perry", "Chad",
                                                            "perrychad@gmail.com");
