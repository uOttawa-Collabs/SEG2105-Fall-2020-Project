        ...
        if (bundle != null)
        {
            ...
            try
            {
                ...
                databaseReference.child("branchServiceRequest").child(
                    account.getUsername().toString()).child("customer name").child("healthCard").setValue(status[2]);
                ...
                buttonAccept.setOnClickListener(
                    ...
                    {
                        databaseReference.child("branchServiceRequest").child(
                            account.getUsername().toString()).child("customer name").child("healthCard").setValue(status[0]);
                        Toast.makeText(getContext(), "Documents approved", Toast.LENGTH_SHORT).show();
                    });
                ...
                buttonReject.setOnClickListener(
                    ...
                    {
                        databaseReference.child("branchServiceRequest").child(
                            account.getUsername().toString()).child("customer name").child("healthCard").setValue(status[1]);
                        Toast.makeText(getContext(), "Documents Rejected", Toast.LENGTH_SHORT).show();
                    });
